...
const skills = [
  // Frontend
  { category: 'Frontend', icon: <FaHtml5 />, name: 'HTML5', color: '#E34F26', level: 90 },
  { category: 'Frontend', icon: <FaCss3Alt />, name: 'CSS3', color: '#1572B6', level: 85 },
  { category: 'Frontend', icon: <FaJs />, name: 'JavaScript', color: '#F7DF1E', level: 80 },
  { category: 'Frontend', icon: <SiTypescript />, name: 'TypeScript', color: '#3178C6', level: 75 },
  { category: 'Frontend', icon: <FaReact />, name: 'React', color: '#61DAFB', level: 80 },
  { category: 'Frontend', icon: <SiNextdotjs />, name: 'Next.js', color: '#000000', level: 70 },
  { category: 'Frontend', icon: <SiThreedotjs />, name: 'Three.js', color: '#000000', level: 65 },
  { category: 'Frontend', icon: <FaWind />, name: 'Tailwind CSS', color: '#38B2AC', level: 85 },

  // Programming Languages
  { category: 'Programming Languages', icon: <FaJava />, name: 'Java', color: '#007396', level: 75 },
  { category: 'Programming Languages', icon: <FaPython />, name: 'Python', color: '#3776AB', level: 70 },
  { category: 'Programming Languages', icon: <FaCode />, name: 'C', color: '#A8B9CC', level: 65 },
  { category: 'Programming Languages', icon: <FaCode />, name: 'Lua', color: '#000080', level: 60 },
  { category: 'Programming Languages', icon: <FaCode />, name: 'Assembly', color: '#6E4C13', level: 55 },

  // Backend & Databases
  { category: 'Backend & Databases', icon: <FaDatabase />, name: 'Oracle SQL', color: '#F80000', level: 70 },

  // Tools
  { category: 'Tools', icon: <FaGitAlt />, name: 'Git', color: '#F05032', level: 80 },
];
              ...
              {skills
                ...
                .map((skill, index) => (
                  ...
                  >
                    ...
                    {/* Skill level indicator - only show after component mounts */}
                    {isMounted && (
